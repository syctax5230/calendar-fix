      ...
      <tr>
        ...
        <td>
          <div class="actions-dropdown">
            <button class="actions-btn" onclick="toggleActionsDropdown(event, '${booking.id}')">Actions</button>
            <div class="actions-menu">
              <button class="actions-menu-item" onclick="openBookingDetail('${booking.id}')">👁 View</button>
              ${booking.status === 'confirmed' ? `<button class="actions-menu-item danger" onclick="openCancelModal('${booking.id}')">✖ Cancel</button>` : ''}
            </div>
          </div>
        </td>
      </tr>
